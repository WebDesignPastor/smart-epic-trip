                ...
                <div className="sm:max-w-sm rounded h-28 sm:h-auto overflow-hidden shadow-lg flex flex-row sm:flex-col relative">
                    ...
                    <div className="sm:px-6 sm:py-4 p-1 flex sm:block flex-col sm:relative justify-around">
                        <div className="flex flex-row justify-between">
                            ...
                            <p className="text-gray-700 text-[14px] sm:text-base">
                                <strong className="text-black hidden sm:block">Adresse: </strong>
                                {fullAddress}
                            </p>
                    ...
                    {window.innerWidth >= 640 && (
                        <div className="flex justify-center items-center mb-4 ">
                            <button onClick={() => HandleAddBtn(content)} className="bg-[#86A873] hover:bg-gray-100 duration-300 transition-duration: 300ms text-gray-800 font-semibold py-2 px-4 border rounded-lg  sm:rounded-full shadow sm:w-[90%] mt-16 sm:mt-1 mb-1 ml-2 h-12">Ajouter au trip</button>
                        </div>
                    )}
                    {window.innerWidth < 640 && (
                        <div className="flex justify-center items-center mb-4 mr-2">
                            <button onClick={() => HandleAddBtn(content)} className="bg-[#86A873] hover:bg-gray-100 duration-300 transition-duration: 300ms text-gray-800 font-semibold py-2 px-4 border rounded-lg  sm:rounded-full shadow sm:w-[90%] mt-16 mb-1 ml-2 h-12">Ajouter</button>
                        </div>
                    )}
